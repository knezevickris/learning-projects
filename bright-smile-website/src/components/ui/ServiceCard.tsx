...
export default function ServiceCard({
  ...
  return (
    <div className={`group p-8 bg-white dark:bg-zinc-900 rounded-3xl border border-dental-100 dark:border-zinc-800 hover:border-dental-300 dark:hover:border-zinc-700 transition-all hover:shadow-2xl hover:shadow-dental-500/5 ${className}`}>
