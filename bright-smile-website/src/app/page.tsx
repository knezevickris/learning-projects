        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 pt-20">
          <div className="max-w-3xl">
            ...
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-accent-500/20 text-accent-400 backdrop-blur-md border border-accent-500/30 text-xs font-bold uppercase tracking-[0.2em] mb-8 animate-fade-in">
              ...
              <span>Modern Care, Friendly Faces</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-white/80 mb-12 max-w-2xl leading-relaxed font-light">
              Providing Riverside with world-class dental excellence since 2019. Join over 5,000 happy patients experiencing compassionate, expert care.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-5">
              <Button href="/contact" className="!px-10 !py-5 text-lg">
                Book an Appointment
              </Button>
              <Button variant="secondary" href="/services" className="!px-10 !py-5 text-lg bg-white/10 text-white border-white/20 backdrop-blur-md hover:bg-white/20">
                Our Services
              </Button>
            </div>
            ...
            <div className="mt-16 flex flex-wrap items-center gap-12 text-white/60">
              <div className="flex flex-col">
                ...
                <span className="text-[11px] uppercase tracking-widest font-bold text-accent-400">Google Rating</span>
              </div>
              <div className="w-px h-12 bg-white/10 hidden sm:block" />
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-white">12+</span>
                <span className="text-[11px] uppercase tracking-widest font-bold text-accent-400">Years Experience</span>
              </div>
              <div className="w-px h-12 bg-white/10 hidden sm:block" />
              <div className="flex flex-col">
                <span className="text-3xl font-bold text-white">5k+</span>
                <span className="text-[11px] uppercase tracking-widest font-bold text-accent-400">Happy Patients</span>
              </div>
            </div>
          </div>
        </div>
